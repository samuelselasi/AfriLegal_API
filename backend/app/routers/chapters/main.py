...
async def create_chapter_for_country(country_id: int,
    ...
    """Function that defines endpoint to create a chapter for a country"""
...
async def read_chapters_by_country(country_id: int,
                                   ...
                                   limit: int = 100,
                                   db: Session = Depends(get_db)):
    """Function that defines endpoint to get chapters based on country_id"""
...
async def read_chapter(chapter_id: int, db: Session = Depends(get_db)):
    """Function that defines endpoint to get chapetr based on id"""
...
async def update_chapter(chapter_id: int,
                         ...
                         db: Session = Depends(get_db)):
    """Function that defines endpoint to update a chapter by id"""
...
async def delete_chapter(chapter_id: int, db: Session = Depends(get_db)):
    """Function that defines endpoint to delete a chapter by id"""
